...
class TestPhysicalUnits:
    ...
    def test_cross_pol_is_physically_plausible(self, scene: AI4ArcticScene) -> None:
    ...
    def test_copol_exceeds_crosspol(self, scene: AI4ArcticScene) -> None:
    ...
    def test_geolocation_lands_in_the_north_atlantic(self, scene: AI4ArcticScene) -> None:
...
class TestMasking:
    ...
    def test_mask_excludes_land_and_retains_most_water(self, scene: AI4ArcticScene) -> None:
...
class TestDetectionChain:
    ...
    @classmethod
    def result(cls, scene: AI4ArcticScene) -> SceneDetectionResult:
    ...
    def test_produces_a_finite_detection_set(self, result: SceneDetectionResult) -> None:
    ...
    def test_suppression_ledger_is_conserved(self, result: SceneDetectionResult) -> None:
        assert len(result.targets) + result.suppression.total_removed == result.raw_candidates

    def test_density_is_operationally_plausible(self, result: SceneDetectionResult) -> None:
    ...
    def test_targets_carry_geography_and_radiometry(self, result: SceneDetectionResult) -> None:
    ...
    def test_regimes_are_classified(
        self, result: SceneDetectionResult, scene: AI4ArcticScene
    ) -> None:
...
class TestSuppressionEffect:
    ...
    def test_filters_remove_speckle_dominated_candidates(self, scene: AI4ArcticScene) -> None:
